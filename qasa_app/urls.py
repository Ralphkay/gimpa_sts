...
urlpatterns = [
    ...
    # path('evaluations/<slug:slug>/', view_evaluation, name='view_evaluation'),
    ...
    path('view_schools/', view_schools, name='view_schools'),
    path('view_schools/create/', create_school, name='create_school'),
    path('view_schools/<slug:slug>/edit/', edit_school, name='edit_school'),
    path('view_schools/<int:pk>/', delete_school, name='delete_school'),
