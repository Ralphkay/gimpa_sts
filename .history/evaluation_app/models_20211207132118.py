...
class Curriculum(models.Model):
    ...
    feedback_1 = models.IntegerField(blank=False,null=False, choices=fe, default=0)
    feedback_2 = models.IntegerField(blank=False,null=False, choices=fe, default=0)
    feedback_3 = models.IntegerField(blank=False,null=False, choices=fe, default=0)
    feedback_4 = models.IntegerField(blank=False,null=False, choices=fe, default=0)
    feedback_5 = models.IntegerField(blank=False,null=False, choices=fe, default=0)
