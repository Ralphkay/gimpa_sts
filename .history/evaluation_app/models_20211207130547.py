...
class Curriculum(models.Model):
    ...
    computed = models.FloatField(default=0, editable=False)
    
    def save(self, *args, **kwargs):
        super(Curriculum, self).save(*args, **kwargs)
        self.computed = ((float(self.feedback_1) + float(self.feedback_2) + float(self.feedback_3) + float(self.feedback_4) + float(self.feedback_5))/5) *
