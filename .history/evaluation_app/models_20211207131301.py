...
class Curriculum(models.Model):
    feedback_1 = models.In(max_length=200, blank=False,null=False, choices=choices, default=0)
    feedback_2 = models.In(max_length=200, blank=False,null=False, choices=choices, default=0)
    feedback_3 = models.In(max_length=200, blank=False,null=False, choices=choices, default=0)
    feedback_4 = models.In(max_length=200, blank=False,null=False, choices=choices, default=0)
    feedback_5 = models.In(max_length=200, blank=False,null=False, choices=choices, default=0)
