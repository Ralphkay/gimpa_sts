...
class Curriculum(models.Model):
    ...
    feedback_2 = models.IntegerField(max_length=1, blank=False,null=False, choices=choices, default=0)
    feedback_3 = models.IntegerField(max_length=1, blank=False,null=False, choices=choices, default=0)
    feedback_4 = models.IntegerField(max_length=1, blank=False,null=False, choices=choices, default=0)
    feedback_5 = models.IntegerField(max_length=1, blank=False,null=False, choices=choices, default=0)
