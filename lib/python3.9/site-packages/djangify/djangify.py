...
def processFile(directory: str, filepath: str, fname: str):
    ...
    Saves the translated files in a newly created directory, "old-Modified_files"
    ...
    save_path = os.path.join(directory, "old-Modified_files")
...
def main():
    ...
    # 'old-Modified_files', else create it.
    if not os.path.exists(os.path.join(directory, "old-Modified_files")):
        os.mkdir(os.path.join(directory, "old-Modified_files"))
